<script>
  ...
  const unidades = [
    {
      ...
      tipo: 'Familiar',
      galeria: [
        '/fotos/familiar/1.jpeg', '/fotos/familiar/2.jpeg', '/fotos/familiar/3.jpeg',
        '/fotos/familiar/4.jpeg', '/fotos/familiar/5.jpeg', '/fotos/familiar/6.jpeg',
        '/fotos/familiar/7.jpeg', '/fotos/familiar/8.jpeg', '/fotos/familiar/9.jpeg',
        '/fotos/familiar/10.jpeg', '/fotos/familiar/11.jpeg', '/fotos/familiar/12.jpeg',
      ...
      detalles: {
        ...
        equipamiento: ['Heladera con freezer grande', 'Cocina con horno completo', 'Amplio asador individual techado', 'Sala comedor integrada y espaciosa', 'Baño completo con ducha']
      }
    },
    {
      id: 2,
      ...
      tipo: 'Familiar',
      galeria: [
        '/fotos/familiar2/1.jpeg', '/fotos/familiar2/2.jpeg', '/fotos/familiar2/3.jpeg',
        '/fotos/familiar2/4.jpeg', '/fotos/familiar2/5.jpeg', '/fotos/familiar2/6.jpeg',
        '/fotos/familiar2/7.jpeg', '/fotos/familiar2/8.jpeg', '/fotos/familiar2/9.jpeg',
        '/fotos/familiar2/10.jpeg', '/fotos/familiar2/11.jpeg'
      ],
      ...
      detalles: {
        ...
        equipamiento: ['Heladera con freezer', 'Cocina con horno completo', 'Asador individual privado', 'Living comedor funcional', 'Baño completo sanitizado']
      }
    },
    {
      id: 3,
      ...
      tipo: 'Matrimonial',
      galeria: [
        '/fotos/matrimonial/1.jpeg', '/fotos/matrimonial/2.jpeg', '/fotos/matrimonial/3.jpeg',
        '/fotos/matrimonial/4.jpeg', '/fotos/matrimonial/5.jpeg', '/fotos/matrimonial/6.jpeg',
        '/fotos/matrimonial/7.jpeg', '/fotos/matrimonial/8.jpeg', '/fotos/matrimonial/9.jpeg',
        '/fotos/matrimonial/10.jpeg', '/fotos/matrimonial/11.jpeg', '/fotos/matrimonial/12.jpeg',
        '/fotos/matrimonial/13.jpeg', '/fotos/matrimonial/14.jpeg'
      ],
      ...
      detalles: {
        ...
        equipamiento: ['Heladera con freezer', 'Vajilla completa para dos', 'Ubicación en la zona más silenciosa', 'Balcón privado con vista al entorno', 'Baño en suite impecable']
      }
    },
    {
      id: 4,
      ...
      tipo: 'Matrimonial',
      galeria: [
        '/fotos/matrimonial2/1.jpeg', '/fotos/matrimonial2/2.jpeg', '/fotos/matrimonial2/3.jpeg',
        '/fotos/matrimonial2/4.jpeg', '/fotos/matrimonial2/5.jpeg', '/fotos/matrimonial2/6.jpeg',
        '/fotos/matrimonial2/7.jpeg', '/fotos/matrimonial2/8.jpeg', '/fotos/matrimonial2/9.jpeg',
        '/fotos/matrimonial2/10.jpeg', '/fotos/matrimonial2/11.jpeg', '/fotos/matrimonial2/12.jpeg'
      ],
      ...
      detalles: {
        ...
        equipamiento: ['Heladera con freezer', 'Vajilla y utensilios completos', 'Cercanía inmediata al sector de río', 'Balcón con aire serrano', 'Baño privado con excelente presión']
      }
    },
    {
      id: 5,
      ...
      tipo: 'Funcional',
      galeria: [
        '/fotos/habitacion/1.jpeg', '/fotos/habitacion/2.jpeg', '/fotos/habitacion/3.jpeg',
        '/fotos/habitacion/4.jpeg', '/fotos/habitacion/5.jpeg', '/fotos/habitacion/6.jpeg',
        '/fotos/habitacion/7.jpeg', '/fotos/habitacion/8.jpeg', '/fotos/habitacion/9.jpeg',
      ...
      detalles: {
        ...
        equipamiento: ['Heladera con congelador compacta', 'Anafe y horno para comidas rápidas', 'Asador individual frente a la unidad', 'Cama matrimonial confortable', 'Baño privado completo']
      }
    }
  ];
  ...
  function irAlFormulario() {
    ...
    // Asumiendo que formData es un estado global o importado
    // formData.unit = unidadActual.nombre; 
    cerrarModal();
    setTimeout(() => {
      const formularioElement = document.getElementById('form_contact');
  ...
  onMount(() => {
    if (seccionRef) {
      ...
      if (amenidadesBlock) animate(amenidadesBlock, { opacity: [0, 1], scale: [0.95, 1] }, { duration: 0.6, delay: 0.2 });
    }
...
<section id="unidades" bind:this={seccionRef} class="py-20 px-4 bg-white">
	<div class="max-w-6xl mx-auto">
		...
		<div bind:this={cardsRef} class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
			{#each unidades as unidad (unidad.id)}
				<div
					class="card-unit bg-white border-2 border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow"
				>
	...
	{#if modalAbierto && unidadActual}
		...
		>
			<button on:click={cerrarModal} class="bg-black bg-opacity-50 w-full h-full absolute z-10"
				>Cerrar Modal</button
			>
			<div
				bind:this={modalRef}
				class="bg-background rounded-lg w-full md:max-w-2xl max-h-[90vh] md:max-h-[95vh] overflow-y-auto overflow-x-hidden scroll-smooth z-30"
			>
				<div
				...
				<div class="p-5 md:p-7 space-y-6">
					...
					<button
						on:click={() => irAlFormulario(unidadActual.id)}
